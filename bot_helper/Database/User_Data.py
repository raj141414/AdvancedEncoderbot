...
async def new_user(user_id, dbsave):
        ...
        DATA[user_id]['muxer'] = {}
        DATA[user_id]['muxer']['preset'] = 'ultrafast'
        DATA[user_id]['muxer']['use_crf'] = False
        DATA[user_id]['muxer']['crf'] = '23'
        DATA[user_id]['muxer']['map_audio'] = True
        DATA[user_id]['muxer']['map_sub'] = True
        DATA[user_id]['muxer']['map'] = True
        DATA[user_id]['muxer']['encode'] = True
        DATA[user_id]['muxer']['encoder'] = 'libx265'
